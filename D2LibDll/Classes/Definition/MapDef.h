...
///////////////////////////////////////////////////////////////////////
// Map Data Related Structs Definition
///////////////////////////////////////////////////////////////////////
typedef struct tagMapData
{
	BYTE iMapID;		// Map ID (rogue encampment 0x01, blood moor 0x02, etc.)
	DWORD dwMapFlag;	// Map data flag
} MAPDATA, *LPMAPDATA;
typedef const tagMapData* LPCMAPDATA;

typedef struct tagMapCount
{
	BYTE iMapID;
	BYTE iCount;
} MAPCOUNT, *LPMAPCOUNT;
typedef const tagMapCount* LPCMAPCOUNT;

// Overloaded Operators for Sorting and Searching
BOOL operator==(const MAPDATA& lhs, const MAPDATA& rhs);
BOOL operator>(const MAPDATA& lhs, const MAPDATA& rhs);
BOOL operator==(const MAPCOUNT& lhs, const MAPCOUNT& rhs);
BOOL operator>(const MAPCOUNT& lhs, const MAPCOUNT& rhs);
