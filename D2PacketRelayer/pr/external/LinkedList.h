...
// LinkedList.h
//
// CLinkedList is a template class which implements a linked list data
// structure without the need of MFC or STL libraries. 
//
// 2003-9-08 Abin
//////////////////////////////////////////////////////////////////////
...
protected:	
	...
	BOOL __Unlink(LPNODE pTarget, BOOL bStoppable = TRUE); // Unlink and delete a node.
...
template <class TYPE, class ARG_TYPE, void (CALLBACK *FREE_TYPE)(TYPE&)>
BOOL CLinkedList<TYPE, ARG_TYPE, FREE_TYPE>::__Unlink(LPNODE pTarget, BOOL bStoppable)
{
