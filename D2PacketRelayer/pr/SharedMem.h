...
public:
	...
	virtual BOOL Create(LPCTSTR lpUniqueName, DWORD dwSize, DWORD dwTimeOut = 50);
	virtual void Close();

	// General memory data access.
	virtual int SetData(const char* pData, DWORD dwSize, DWORD dwStartPosition);
	virtual int GetData(char* pBuffer, DWORD dwSize, DWORD dwStartPosition);
