...
// 4/11/02 -- Bin Liu	Adjustable background colour
...
public:
    ...
    void SetColours(COLORREF crLinkColour, COLORREF crVisitedColour, 
                    COLORREF crHoverColour = -1, COLORREF crBgColour = -1);
    ...
    void SetUnderline(int nUnderline = ulAlways);
...
protected:
    ...
    COLORREF m_crBgColour;							// Background color
