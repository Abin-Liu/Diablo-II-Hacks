...
// Require the remote process to have at least one valid window.
/////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////
// DLL Helper Functions (Windows 95/98/NT/ME/2000/XP/2003)
//-----------------------------------------------------------------------
// For All Windows Plateforms.
/////////////////////////////////////////////////////////////////////////
HMODULE __declspec(dllexport) RemoteGetModuleHandleA(HWND hTargetWnd, LPCSTR lpszDllPath, DWORD dwTimeout = REMOTE_TIMEOUT);
HMODULE __declspec(dllexport) RemoteGetModuleHandleA(DWORD dwTargetProcessID, LPCSTR lpszDllPath);
HMODULE __declspec(dllexport) RemoteGetModuleHandleW(HWND hTargetWnd, LPCWSTR lpszDllPath, DWORD dwTimeout = REMOTE_TIMEOUT);
HMODULE __declspec(dllexport) RemoteGetModuleHandleW(DWORD dwTargetProcessID, LPCWSTR lpszDllPath);
