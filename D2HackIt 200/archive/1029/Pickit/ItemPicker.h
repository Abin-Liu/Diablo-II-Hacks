...
protected:
	...
	///////////////////////////////////////////////////////////////////////
	LPCITEMCONFIG FindItem(LPCGAMEUNIT lpUnit, BYTE iItemType, SIMPLEITEM& si, BOOL& bValuable);
	...
	// Temporary members, never mind
	ITEMCONFIG m_tempConfig;
	SIMPLEITEM m_tempItem;
};
