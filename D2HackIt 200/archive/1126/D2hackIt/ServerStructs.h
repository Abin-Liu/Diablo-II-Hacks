#ifndef __SERVERSTRUCTS_H__
#define __SERVERSTRUCTS_H__
...
typedef struct privateserverinfo_t
{
	...
	struct
	{
		...
		FINGERPRINTSTRUCT	GamePacketReceivedIntercept3;
...
typedef VOID (__cdecl *fnOnGameTimerTick2)(DWORD dwGameTime);
typedef VOID (__cdecl *fnOnDraw)(CGameDC* pDC, LPCRECT lpScreenRect);
typedef VOID (__cdecl *fnOnGamePacketAfterReceived)(const BYTE* aPacket, DWORD aLength);
