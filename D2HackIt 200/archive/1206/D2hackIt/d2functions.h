...
D2EXPFUNC(D2CLIENT, TestPvpFlag, DWORD __fastcall, (DWORD planum1, DWORD planum2, DWORD flagmask))
...
D2EXPASM(D2CLIENT, ChangeActPatch1);
D2EXPASM(D2CLIENT, ChangeActPatch2);
D2EXPASM(D2CLIENT, SetCursorPosPatch);
D2EXPASM(D2WIN, SetCursorPosPatch);
...
D2EXPFUNC(D2COMMON, GetCheckWp, int __stdcall, (DWORD addr, int wp)); 			// #11146
...
D2EXPFUNC(D2COMMON, ItemGetMagicalMods, char * __stdcall, (int modnum));// #10604
...
D2EXPFUNC(D2COMMON, CheckPageForRoom, bool __stdcall, (Inventory * ptInventory, UnitItem * ptItem, int, BYTE * ptX, BYTE * ptY, int page));
...
D2EXPFUNC(D2GFX, DrawLine, void __stdcall, (DWORD X1, DWORD Y1, DWORD X2, DWORD Y2, BYTE color, BYTE));
// keep window
D2EXPASM(D2GFX, KeepD2WindowPatch1);
D2EXPASM(D2GFX, KeepD2WindowPatch2);
D2EXPASM(D2GFX, KeepD2WindowPatch3);
...
//D2EXPFUNC(D2GFX, DrawAutomapCell, void __stdcall, (CellContext *context, DWORD xpos, DWORD ypos, RECT *cliprect, DWORD bright))
D2EXPFUNC(D2GFX, DrawAutomapCell2, void __stdcall, (CellContext *context, DWORD xpos, DWORD ypos, DWORD bright2, DWORD bright, BYTE *coltab))
D2EXPFUNC(D2CMP, InitCellFile, void __stdcall, (void *cellfile, CellFile **outptr, char *srcfile, DWORD lineno, DWORD filever, char *filename))
D2EXPFUNC(D2CMP, DeleteCellFile, void __stdcall, (CellFile *cellfile))


extern Roster **p_D2CLIENT_FirstRosterUnit;
extern RosterPet **p_D2CLIENT_FirstRosterPet;
extern bool *p_D2CLIENT_HasHighlight;
...
extern DWORD *p_D2CLIENT_WpTable;
