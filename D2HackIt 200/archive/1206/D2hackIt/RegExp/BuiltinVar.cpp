...
int GetBV_two_hand(DWORD dwItemID, LPCSTR lpszItemCode, LPCITEMMOD lpMod, DWORD dwModCount);
int GetBV_min_damage(DWORD dwItemID, LPCSTR lpszItemCode, LPCITEMMOD lpMod, DWORD dwModCount);
int GetBV_max_damage(DWORD dwItemID, LPCSTR lpszItemCode, LPCITEMMOD lpMod, DWORD dwModCount);
...
static const BUILTINVAR BVS[] = {
	...
	{ "two_hand", GetBV_two_hand, 0 },
	{ "min_damage", GetBV_min_damage, 0 },
	{ "max_damage", GetBV_two_hand, 0 },
	{ "", NULL, 0 }
};
...
{
	DWORD dwVal;
	return GetItemDamage(dwItemID, &dwVal, NULL);
}

int GetBV_max_damage(DWORD dwItemID, LPCSTR lpszItemCode, LPCITEMMOD lpMod, DWORD dwModCount)
{
	DWORD dwVal;
	return GetItemDamage(dwItemID, NULL, &dwVal);
}
