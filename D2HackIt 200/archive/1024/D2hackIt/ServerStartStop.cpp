...
CTickThread g_clientTickThread; // v2.00
CTickThread g_serverTickThread; // v2.00
CTickThread	g_messageTickThread; // 2.00

// Added v2.00
void DefineOffsets(); // offsets.cpp
BOOL D2InitializeScreenDraw(); // OnDraw.cpp
BOOL D2UninitializeScreenDraw(); // OnDraw.cpp
...
err_quit:
	...
	g_serverTickThread.Start(ServerTimerTick);
	...
	// v2.00
	if (!D2InitializeScreenDraw())
		GamePrintError("D2InitializeScreenDraw Failed!");
...
BOOL PRIVATE ServerStop(void)
{
	...
	// End threads first!
	g_serverTickThread.Stop(2500); // v2.00
	g_clientTickThread.Stop(2500); // v2.00
	g_messageTickThread.Stop(2500); // v2.00

	D2UninitializeScreenDraw(); // v2.00
	Proc_OnGameLeave();	 // v2.00
