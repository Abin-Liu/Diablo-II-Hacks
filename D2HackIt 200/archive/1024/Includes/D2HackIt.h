...
#define __SERVERBUILD__			MAKELONG(10, 24)
...
MAPPOS EXPORT GetRandomPosition(int nRadiusMin, int nRadiusMax, int nAngleMin = 0, int nAngleMax = 360, LPCMAPPOS lpOrigin = NULL);
int EXPORT GetAngle(WORD x1, WORD y1, WORD x2, WORD y2);
int EXPORT GetAngleFrom(WORD x, WORD y);
