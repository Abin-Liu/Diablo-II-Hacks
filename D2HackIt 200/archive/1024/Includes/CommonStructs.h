...
/////////////////////////////////////////////////////////////////////
#define PATH_MAX_NODE	1024
typedef struct tagPath
{
	MAPPOS posStart;					// Start position
	MAPPOS posEnd;						// Destination position
	MAPPOS aPathNodes[PATH_MAX_NODE];	// Path nodes between posStart and posEnd
...
typedef MAPPOS (__cdecl *fnGetRandomPosition)(int nRadiusMin, int nRadiusMax, int nAngleMin, int nAngleMax, LPCMAPPOS lpOrigin);
