...
////////////////////////////////////////////////////////////////////
// Stuff for Screen Drawing
// Added v2.00 by Abin
////////////////////////////////////////////////////////////////////
typedef BOOL (__cdecl *fnD2TextOut)(LPCSTR lpszText, long x, long y, BYTE iFont);
typedef BOOL (__cdecl *fnD2DrawText)(LPCSTR lpszText, LPCRECT lpRect, BYTE iFont, UINT nAlign);
typedef POINT (__cdecl *fnD2MoveTo)(long x, long y);
typedef BOOL (__cdecl *fnD2LineTo)(long x, long y, BYTE iColor);
typedef BOOL (__cdecl *fnD2Rectangle)(LPCRECT lpRect, BYTE iColor, BYTE iTransparency);
typedef BOOL (__cdecl *fnD2Frame)(LPCRECT lpRect, BYTE iColor);
...
/////////////////////////////////////////////////////////////////////
#define PATH_MAX_NODE	512
typedef struct tagPath
{
	POINT ptStart;						// Start position
	POINT ptEnd;						// Destination position
	POINT aPathNodes[PATH_MAX_NODE];	// Path nodes between posStart and posEnd
	DWORD dwNodeCount;					// Number of path nodes
} PATH, *LPPATH;
...
typedef DWORD (__cdecl *fnCalculateTeleportPath)(WORD x, WORD y, LPPATH lpBuffer);
...
typedef int (__cdecl *fnGetMagicalModName)(WORD wPrefixOrSuffix, LPSTR lpszBuffer, DWORD dwMaxChars);
...
typedef POINT (__cdecl *fnScreenToMapCoords)(POINT ptScreenCoords);
typedef POINT (__cdecl *fnMapToScreenCoords)(POINT ptMapPosition);
...
typedef int (__cdecl *fnGetAngle)(WORD x1, WORD y1, WORD x2, WORD y2);
typedef DWORD (__cdecl *fnCalculateWalkPath)(WORD x, WORD y, LPPATH lpBuffer);
typedef BOOL (__cdecl *fnCreateCollisionMap)(); // 1000 * 1000
...
//	fnGetInfoStruct					GetInfoStruct;
	...
	fnGetMagicalModName				GetMagicalModName;		// 2.00 (Abin)
...
typedef int (__cdecl *fnGetAngleFrom)(WORD x, WORD y);
