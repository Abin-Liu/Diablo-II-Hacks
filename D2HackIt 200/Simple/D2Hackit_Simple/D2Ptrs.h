...
///////////////////////////////////////////////
enum {DLLNO_D2CLIENT, DLLNO_D2COMMON, DLLNO_D2GFX, DLLNO_D2LANG, DLLNO_D2WIN, DLLNO_D2NET, DLLNO_D2GAME, DLLNO_D2LAUNCH, DLLNO_FOG, DLLNO_BNCLIENT, DLLNO_STORM, DLLNO_D2CMP};
...
D2FUNCPTR(D2CLIENT, TestPvpFlag, DWORD __fastcall, (DWORD planum1, DWORD planum2, DWORD flagmask), 0xAB900)
...
D2ASMPTR(D2CLIENT, ScreenPrint, 0x81FF7);	// (d2bs)This is a call opcode, so patch at +1 with &MyFunc - (ScreenPrint+1+4);
...
D2ASMPTR(D2CLIENT, ChangeActPatch1, 0x845C6);
D2ASMPTR(D2CLIENT, ChangeActPatch2, 0x845A1);
D2ASMPTR(D2CLIENT, SetCursorPosPatch, 0xCE080);
D2ASMPTR(D2WIN, SetCursorPosPatch, 0x1A2F4);
...
D2FUNCPTR(D2COMMON, ItemGetMagicalMods, char * __stdcall, (int modnum), -0x296C);// #10604
...
D2FUNCPTR(D2COMMON, CheckPageForRoom, bool __stdcall, (Inventory * ptInventory, UnitItem * ptItem, int, BYTE * ptX, BYTE * ptY, int page), -0x2805); // from Ninjai
D2FUNCPTR(D2COMMON, GetExperienceForLevel, int __stdcall, (int PlayerClass, int TargetLevel), -0x2984); 			// #10628
D2FUNCPTR(D2COMMON, GetCheckWp, int __stdcall, (DWORD addr, int wp), 0x83DE0); 			// #11146
...
D2FUNCPTR(D2GFX, DrawLine, void __stdcall, (DWORD X1, DWORD Y1, DWORD X2, DWORD Y2, BYTE color, BYTE), -0x2749);
// keep window
D2ASMPTR(D2GFX, KeepD2WindowPatch1, 0x4939);
D2ASMPTR(D2GFX, KeepD2WindowPatch2, 0x4D18);
D2ASMPTR(D2GFX, KeepD2WindowPatch3, 0x4F79);
...
D2VARPTR(D2CLIENT, WpTable, DWORD, 0x11A9B9);
