...
/*
stuff been moved to "CommonStructs.h"
///////////////////////////////////////////////
// Originally ackmed's Code(Shopbot) With Some Modification
///////////////////////////////////////////////
...
BOOL D2ParseItem(const BYTE* aPacket, DWORD aLen, LPITEM lpItem); // Parses item info from a packet
...
DWORD D2ItemCode2Dword(LPCSTR lpszItemCode); // convert a string into dword
