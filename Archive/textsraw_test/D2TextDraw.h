...
public:
	...
	// Utility Functions
	//////////////////////////////////////////////////////////////////
	HWND GetD2WndHandle() const; // Get the D2 game window handle
	SIZE GetScreenSize() const; // Get the game screen size
...
protected:
	...
	BOOL m_bSharedMemCreated;
	FARPROC m_lpfnGfxGetScreenSize; // Function pointer for retrieveing screen size
};
