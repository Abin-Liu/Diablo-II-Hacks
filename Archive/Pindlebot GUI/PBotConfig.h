...
#define PB_MAX_CHARNAME		15
#define PB_MAX_SAFETYNAME	32
#define PB_MAX_COMBO		64
#define PB_MAX_ACTION		64
enum { PB_AMMO_NONE = 0, PB_AMMO_ARROW, PB_AMMO_BOLT, PB_AMMO_THROWING };
enum { PB_LOCATION_NORMAL = 0, PB_LOCATION_CLOSE, PB_LOCATION_FAR };
enum { PB_TARGET_NONE = 0, PB_TARGET_PINDLE, PB_TARGET_FRONT, PB_TARGET_BEHIND };
enum { PB_ACTION_BEFORERED = 0, PB_ACTION_INRED, PB_ACTION_ONPINDLE, PB_ACTION_ONCORPSE };
